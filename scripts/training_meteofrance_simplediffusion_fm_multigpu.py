...
from meteolibre_model.dit.model_meteofrance_simplediffusion_fm import (
...
MODEL_DIR = "models/meteolibre_simplediffusion_multigpu_fm/"
...
def log_sample_image(model, batch, step, accelerator):
    ...
    with torch.no_grad():
        ...
        sample = model.sample(
            ...
            x_minute,
            sampling_steps=256,
            visualize_path="/workspace/meteolibre_model/images",
        )
...
def main():
    ...
    accelerator.init_trackers("meteofrance-fm-training_" + id_run, config=hps)
